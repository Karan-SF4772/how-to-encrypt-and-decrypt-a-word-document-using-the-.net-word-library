...
A quick start project that shows how to Encrypt and Decrypt a Word document using the [.NET Word Library](https://www.syncfusion.com/document-sdk/net-word-library).
...
*   **Documentation:** [Encrypt and Decrypt the Word documents](https://help.syncfusion.com/document-processing/word/word-library/net/working-with-security)
